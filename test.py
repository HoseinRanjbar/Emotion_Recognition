...
parser.add_argument('--test_segment_root',type=str)
...
save_path = os.path.join('/home/CSLR_IIGA/evaluation', start_date)
...
test_dataloader, test_size = loader(csv_file=test_path[1],
                ...
                segment_path=args.test_segment_root,
...
#python3 evaluate_slr.py --data /home/cedra/sign_language_recognition/phoenix2014-release/phoenix-2014-multisigner --model_path /home/cedra/sign_language_recognition/san/trained_model/2023-04-12-18.36/epoch_60_wer_0.6272177703199525.pt --lookup_table /home/cedra/sign_language_recognition/SLR_lookup_pickle.txt --data_stats /home/cedra/sign_language_recognition/san/source/data_stats.pt --hand_stats /home/cedra/sign_language_recognition/san/source/hand_stats.pt
